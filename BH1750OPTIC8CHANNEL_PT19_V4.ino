 ...
 * 28-11-2020 range aangepast van -30 30 naar -5 5 deze werkt nu goed.   *
 * Robert D'Arcangelo                                                    *
 *************************************************************************
  Connection:
...
const int numReadings = 6;      // array  for data annalog
...
int sensorPin = A0;    //light sensor inputpin for leonardo
int max_v = INT_MIN;
int max_i = 0;
...
//---------------------------------------------------------------------
          ...
          lux=max_v*2;   //hoogste waarde uit array
...
//------------------------------einde 1...4.------------------------------------------  
    ...
    if (lux >0 && Teller==12){
      ...
      if (lux >0 && Teller==14){
         ...
         if (lux > 1){
           Serial.println(lux*2-70);
         //  luxMem8=lux*2;
         EEPROM.write(MEM8addr, (lux*2-70)/4);    //lux*2-70/4
           Serial.println("Release Button..!");
           Gem=0;
           Teller=15; 
         }      
